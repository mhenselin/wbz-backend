<div class="modal fade" id="NewEventModalCenter" tabindex="-1" role="dialog" aria-labelledby="NewEventModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('event_create')); ?>">
                <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\xampp\htdocs\kunden\wbz_backend\resources\views/calendar/createEvent.blade.php ENDPATH**/ ?>